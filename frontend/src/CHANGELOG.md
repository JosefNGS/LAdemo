# Frontend Source Code Changelog

All notable changes to frontend source code will be documented in this file.
...
### Added
- Initial frontend source code changelog [Cursor]

---

## Notes

- **Location**: `frontend/src/CHANGELOG.md`
- **Maintained By**: Development Team (Josef Lindbom - UI/UX Lead)
- **Update Frequency**: Every change to frontend source code must be logged here
