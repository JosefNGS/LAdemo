...
All notable changes to frontend services will be documented in this file.
...
### Added
- Initial frontend services changelog [Developer: Josef Lindbom]

---

## Notes

- **Location**: `frontend/src/services/CHANGELOG.md`
- **Maintained By**: Development Team
- **Update Frequency**: Every change to frontend services must be logged here
