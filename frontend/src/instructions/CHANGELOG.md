...
All notable changes to this folder will be documented in this file.
...
### Added
- Created README.md for `frontend/src/instructions/` folder [Cursor]
- Created CHANGELOG.md for `frontend/src/instructions/` folder [Cursor]
- Instructions folder now has required README.md and CHANGELOG.md files [Cursor]
