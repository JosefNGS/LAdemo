# Frontend Data Changelog

All notable changes to frontend data files will be documented in this file.
...
### Added
- Initial frontend data changelog [Developer: Josef Lindbom]
...
- **Update Frequency**: Every change to frontend data files must be logged here
