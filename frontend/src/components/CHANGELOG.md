# Frontend Components Changelog

All notable changes to frontend components will be documented in this file.
...
### Added
- Initial frontend components changelog [Developer: Josef Lindbom]

---

## Notes

- **Location**: `frontend/src/components/CHANGELOG.md`
- **Maintained By**: Development Team (Josef Lindbom - UI/UX Lead)
- **Update Frequency**: Every change to frontend components must be logged here
