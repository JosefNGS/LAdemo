# Changelog - NSR Templates

All notable changes to NSR templates will be documented in this file.
...
### Added
- Created templates folder [Cursor]
- Created `project-structure-template.md` for generating BitNexus-like project structures [Cursor]
- Initial templates changelog [Cursor]
