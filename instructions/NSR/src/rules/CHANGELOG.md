...
All notable changes to NSR rules will be documented in this file.
...
### Added
- Created rules folder [Cursor]
- Created `cursor-rules-template.md` for generating `.cursorrules` files [Cursor]
- Initial rules changelog [Cursor]
