# BMAD-METHOD Rules Changelog

All notable changes to BMAD-METHOD rules will be documented in this file.
...
### Added
- Initial BMAD-METHOD rules changelog [Developer: Josef Lindbom]

---

## Notes

- **Location**: `rules/bmad-method/CHANGELOG.md`
- **Source**: Rules extracted from `instructions/BMAD-METHOD/`
- **Maintained By**: Development Team
- **Update Frequency**: Update when BMAD-METHOD framework is updated or rules change
