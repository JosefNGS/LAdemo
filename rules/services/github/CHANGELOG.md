# GitHub Service Rules Changelog

All notable changes to GitHub service rules will be documented in this file.
...
### Added
- Initial GitHub service rules changelog [Developer: Josef Lindbom]

---

## Notes

- **Location**: `rules/services/github/CHANGELOG.md`
- **Source**: Rules extracted from `docs/Services/github/SERVICE_RULES.md`
- **Maintained By**: Development Team
- **Update Frequency**: Update when GitHub service rules change
