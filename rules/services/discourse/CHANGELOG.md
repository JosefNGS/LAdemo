# Discourse Service Rules Changelog

All notable changes to Discourse service rules will be documented in this file.
...
### Added
- Initial Discourse service rules changelog [Developer: Josef Lindbom]

---

## Notes

- **Location**: `rules/services/discourse/CHANGELOG.md`
- **Source**: Rules extracted from `docs/Services/discourse/SERVICE_RULES.md`
- **Maintained By**: Development Team
- **Update Frequency**: Update when Discourse service rules change
