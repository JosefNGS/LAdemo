# Changelog - Service Rules

All notable changes to service rules will be documented in this file.
...
### Added
- Created CHANGELOG.md for `rules/services/` folder [Cursor]
- Service rules folder now has required README.md and CHANGELOG.md files [Cursor]
