# n8n Service Rules Changelog

All notable changes to n8n service rules will be documented in this file.
...
### Added
- Initial n8n service rules changelog [Cursor]

---

## Notes

- **Location**: `rules/services/n8n/CHANGELOG.md`
- **Source**: Rules extracted from `docs/Services/n8n/SERVICE_RULES.md`
- **Maintained By**: Development Team
- **Update Frequency**: Update when n8n service rules change
