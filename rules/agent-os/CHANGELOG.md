# Agent OS Rules Changelog

All notable changes to Agent OS rules will be documented in this file.
...
### Added
- Initial Agent OS rules changelog [Developer: Josef Lindbom]

---

## Notes

- **Location**: `rules/agent-os/CHANGELOG.md`
- **Source**: Rules extracted from `instructions/.agent-os/`
- **Maintained By**: Development Team
- **Update Frequency**: Update when Agent OS framework is updated or rules change
