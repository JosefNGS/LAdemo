...
### Added
- Created README.md for `docs/` folder [Cursor]
- Created CHANGELOG.md for `docs/` folder [Cursor]
- Documentation folder now has required README.md and CHANGELOG.md files [Cursor]
