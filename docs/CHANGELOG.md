...
All notable changes to the documentation folder will be documented in this file.
...
### Added
- Created README.md for `docs/` folder [Developer: Josef Lindbom]
- Created CHANGELOG.md for `docs/` folder [Developer: Josef Lindbom]
- Documentation folder now has required README.md and CHANGELOG.md files [Developer: Josef Lindbom]
